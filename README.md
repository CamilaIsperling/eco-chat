...
O projeto **EcoChatGPTGPT** nasceu como proposta de TCC para investigar uma pergunta simples e importante:
...
O **EcoChatGPTGPT** é uma extensão Chrome construída com **JavaScript, React, Glamor, Vite e Manifest V3** para monitorar o uso do **ChatGPT** e traduzir a conversa em **métricas ambientais aproximadas**, com foco em **transparência, educação e uso responsável de IA**.
